...
import TalentRecommendationsItems from "./components/Search/TalentRecommendations"
...
//  import Apps from "./components/Test"
 import PreferenceCards from "./components/Search/AllUserPreferences"
    ...
    return (
        <div>
            <Routes>
                ...
                <Route path='TalentRecommendationsItems' element={<TalentRecommendationsItems />} />  
                ...
                <Route path='AllUserPreferences' element={< PreferenceCards/>} />            
